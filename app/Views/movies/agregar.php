<?php require RUTA_APP . '/Views/inc/header.php' ?>
    ...
    <div class="container">
        ...
        <form action="<?php echo RUTA_URL;?>/movies/agregar" method="POST">
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">imdb_id</label>
                <input type="text" name="imdb_id" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="actors" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="premiere" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="genres" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div>
